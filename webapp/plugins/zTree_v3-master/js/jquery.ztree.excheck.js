  ...
  var _consts = {
    ...
    _beforeA = function (setting, node, html) {
      if (setting.check.enable) {
        ...
        html.push("<span ID='", node.tId, consts.id.CHECK, "' class='", view.makeChkClass(setting, node), " " , node[setting.data.simpleData.customClass],"' treeNode", consts.id.CHECK, (node.nocheck === true ? " style='display:none;'" : ""), "></span>");
      }
    },
    ...
    _view = {
      ...
      makeChkClass: function (setting, node) {
        ...
        return consts.className.BUTTON + " chkbutton " + c.DEFAULT + " " + chkName;
      },
