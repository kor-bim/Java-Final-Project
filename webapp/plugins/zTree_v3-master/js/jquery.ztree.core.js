...
(function ($) {
  var settings = {}, roots = {}, caches = {},
    ...
    data = {
      ...
      //===========
      nodeValue: function (setting, node) {
    	  var t = setting.data.key.value === "" ? setting.data.key.name : setting.data.key.value;
    	  var rawValue = "" + node[t];
    	  return rawValue;
      },
      //=============
    ...
    view = {
      ...
      makeDOMNodeIcon: function (html, setting, node) {
        ...
        html.push("<span id='", node.tId, consts.id.ICON,
          "' title='' treeNode", consts.id.ICON, " class='", view.makeNodeIcoClass(setting, node), " " , node[setting.data.simpleData.customClass],
          "' style='", view.makeNodeIcoStyle(setting, node), "'></span><span id='", node.tId, consts.id.SPAN,
          "' class='", consts.className.NAME, " " , node[setting.data.simpleData.customClass],
          "' value='", node[setting.data.simpleData.valKey],
          "' data-mem='", node[setting.data.simpleData.dataSet] ,
          "'>", name, "</span>");
      },
